...
// PIN Def - Pin number that the data signal will be on the chip to the pixels
// NEONUM Def - The number of pixels on the strip
...
Adafruit_NeoPixel strip = Adafruit_NeoPixel(NEONUM, PIN, NEO_RGB + NEO_KHZ800);
